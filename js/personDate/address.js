...
//$.fn.sjld = function (shenfen_top, chengshi_top, quyu_top) {
//    var sfp = shenfen_top + ' p'
//    var csp = chengshi_top + ' p'
//    var qyp = quyu_top + ' p'
//    var sfs = shenfen_top + ' .m_zlxg2'
//    var css = chengshi_top + ' .m_zlxg2'
//    var qys = quyu_top + ' .m_zlxg2'
//    var sfli = shenfen_top + ' ul li'
//    var csli = chengshi_top + ' ul li'
//    var qyli = quyu_top + ' ul li'
//    $('.m_zlxg').click(function () {
//        $(this).find('.m_zlxg2').slideDown(200);
//    })
//    $('.m_zlxg').mouseleave(function () {
...
//        var sfmcmr = sfgsmr[a].name;
//        var sfnrmr = "<li>" + sfmcmr + "</li>";
//        $(shenfen_top).find('ul').append(sfnrmr);
//    }
//    for (b = 0; b < csgsmr.length; b++) {
//        var csmcmr = csgsmr[b].name;

//        var csnrmr = "<li>" + csmcmr + "</li>";
//        $(chengshi_top).find('ul').append(csnrmr);
//        kuandu[b] = csmcmr.length * 14 + 20;
//    }
//    for (c = 0; c < qygsmr.length; c++) {
//        var qymcmr = qygsmr[c];
//        var qynrmr = "<li>" + qymcmr + "</li>";
//        $(quyu_top).find('ul').append(qynrmr);
//    }
//    Array.max = function (array) {
//        return Math.max.apply(Math, array);
//    }
...
//    $(sfli).click(function () {
//        var dqsf = $(this).text();
//        $(shenfen_top).find('p').text(dqsf);
//        $(shenfen_top).find('p').attr('title', dqsf);
//        var sfnum = $(this).index();

//        var csgs = provinceList[sfnum].cityList;
//        var csgs2 = provinceList[sfnum].cityList[0].areaList;
//        $(chengshi_top).find('ul').text('');
//        var kuandu = new Array();
//        for (i = 0; i < csgs.length; i++) {
//            var csmc = csgs[i].name;
//            var csnr = "<li>" + csmc + "</li>";
//            $(chengshi_top).find('ul').append(csnr);
//            kuandu[i] = csmc.length * 14 + 20;
//        }
//        Array.max = function (array) {
//            return Math.max.apply(Math, array);
...
//        }
//        var qygsdqmr = provinceList[sfnum].cityList[0].areaList;
//        $(quyu_top).find('ul').text('');
//        for (j = 0; j < qygsdqmr.length; j++) {
//            var qymc = qygsdqmr[j];
//            var qynr = "<li>" + qymc + "</li>";
//            $(quyu_top).find('ul').append(qynr);
//        }
//        $(csp).text(csgs[0].name);
//        $(qyp).text(csgs2[0]);
//        $('#sfdq_num').val(sfnum);
...
//                var dqsf_num = $('#sfdq_num').val();
//            }
//            $(chengshi_top).find('p').text(dqcs);
//            $(chengshi_top).find('p').attr('title', dqcs);
//            var csnum = $(this).index();
//            var qygs = provinceList[dqsf_num].cityList[csnum].areaList;
//            $(quyu_top).find('ul').text('');
//            for (j = 0; j < qygs.length; j++) {
...
//            $(qyli).click(function () {
//                var dqqy = $(this).text();
//                $(quyu_top).find('p').text(dqqy);
//                $(quyu_top).find('p').attr('title', dqqy);
